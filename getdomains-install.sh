...
EOF
    ...
    if [ "$TUNNEL" == 'awg' ]; then
        ...
        printf "\033[32;1m\n"
        printf "\033[32;1mTelegram subnets can be found here:\n"
        printf "\033[32;1m\n"
        printf "\033[32;1m    https://raw.githubusercontent.com/itdoginfo/allow-domains/refs/heads/main/Subnets/IPv4/telegram.lst\n"
        printf "\033[32;1m\n"
    fi

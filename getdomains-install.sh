...
EOF
    ...
    if [ "$TUNNEL" == 'awg' ]; then
        ...
        printf "\033[32;1m     config rule\033[0m\n"
        printf "\033[32;1m         option name 'telegram via awg0'\033[0m\n"
        printf "\033[32;1m         option src 'lan'\033[0m\n"
        printf "\033[32;1m         option dest '*'\033[0m\n"
        printf "\033[32;1m         option set_mark '0x1'\033[0m\n"
        printf "\033[32;1m         option target 'MARK'\033[0m\n"
        printf "\033[32;1m         list dest_ip '91.108.56.0/22'\033[0m\n"
        printf "\033[32;1m         list dest_ip '91.108.4.0/22'\033[0m\n"
        printf "\033[32;1m         list dest_ip '91.108.8.0/22'\033[0m\n"
        printf "\033[32;1m         list dest_ip '91.108.16.0/22'\033[0m\n"
        printf "\033[32;1m         list dest_ip '91.108.12.0/22'\033[0m\n"
        printf "\033[32;1m         list dest_ip '149.154.160.0/20'\033[0m\n"
        printf "\033[32;1m         list dest_ip '91.105.192.0/23'\033[0m\n"
        printf "\033[32;1m         list dest_ip '91.108.20.0/22'\033[0m\n"
        printf "\033[32;1m         list dest_ip '185.76.151.0/24'\033[0m\n"
        printf "\033[32;1m         list proto 'all'\033[0m\n"
        printf "\033[32;1m\033[0m\n"
        printf "\033[32;1mTelegram subnets can be found here:\033[0m\n"
        printf "\033[32;1m\033[0m\n"
        printf "\033[32;1m    https://raw.githubusercontent.com/itdoginfo/allow-domains/refs/heads/main/Subnets/IPv4/telegram.lst\033[0m\n"
        printf "\033[32;1m\033[0m\n"
    fi
